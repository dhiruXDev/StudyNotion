...
export const MyProfile = () => {
  ...
  return (
    <div className=' text-richblack-5  w-[100vw] mx-auto flex flex-col gap-y-3  px-[2rem] mt-10  overflow-x-hidden'>  
          <span className=' text-base text-richblack-300 font-medium'> Home  / Dashboard / <span className=' text-yellow-50'>{pathname.pathname.split("/").at(-1)}</span> </span>
           ...
           <div className=' flex lg:w-11/12 w-[100%] flex-col gap-3  mx-auto  mt-[1rem] lg:ml-[9rem]  justify-center'>
                      {/*Section 1  */}
                    <div className=' relative    flex items-center  w-full md:w-[60%] justify-between gap-x-2 py-6 px-[2rem]  border-[1.8px] border-richblack-700 rounded-xl   bg-richblack-800'>
                    ...
                    <div className=' relative   flex items-center  w-full md:w-[60%] justify-between gap-x-2 py-6 px-[2rem]  border-[1.8px] border-richblack-700 rounded-xl   bg-richblack-800'>
                                   <div className='flex gap-1  flex-col max-w-[80%] '>
                                             ...
                                             <p className=' text-[14px] leading-[22px] text-richblack-300'>{user.additionalDetails.about ??  "Write something here about here"}</p>
                                   </div>
                                   {/*  */}
                                   <IconBtn
                                        text={"Edit"}
                    ...
                    {/* Section 3 */}
                    <div className=' flex  flex-col bg-richblack-800 w-full md:w-[60%] gap-5    border-richblack-700 rounded-xl  py-6 px-[2rem]  border-[1.8px]  '>
